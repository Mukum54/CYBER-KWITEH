...
<svelte:head>
        ...
        <meta
                name="title"
                content="{VERT_NAME} — Free File Converter | CYBER WEB"
        />
        <meta
                name="description"
                content="CYBER KWITEH is a futuristic file conversion tool by CYBER WEB. Convert images, audio, documents, and video locally on your device. Built by Mukum Dieudonne."
        />
        <meta name="keywords" content="file converter, image converter, video converter, audio converter, document converter, cyber web, mukum dieudonne, cameroon, free, open source" />
        <meta name="author" content="Mukum Dieudonne" />
        <meta property="og:url" content="https://cyberkwiteh.vercel.app" />
        ...
        <meta property="twitter:domain" content="cyberkwiteh.vercel.app" />
        <meta property="twitter:url" content="https://cyberkwiteh.vercel.app" />
        <meta
        ...
        <meta name="twitter:creator" content="@cyberwebcm" />
        <link rel="manifest" href="/manifest.json" />
        <link rel="canonical" href="https://cyberkwiteh.vercel.app/" />
        {#if enablePlausible}
                <script
                        defer
