...
<style lang="postcss">
        .file-category-card {
                ...
                border: 1px solid hsla(25, 100%, 50%, 0.1);
        }
        ...
        .icon-container {
                ...
                box-shadow: 0 0 15px hsla(25, 100%, 50%, 0.4);
        }

        /* Cyber glow for cards on dark mode */
        :global(.dark) .file-category-card {
                box-shadow: var(--shadow-panel), 0 0 30px hsla(25, 100%, 50%, 0.1);
        }
</style>
