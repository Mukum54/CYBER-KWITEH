...
<div class="fixed top-0 left-0 w-screen h-screen -z-50 pointer-events-none cyber-grid-bg"></div>
...
<style>
        .cyber-grid-bg {
                ...
                background-image: 
                        linear-gradient(hsla(25, 100%, 50%, 0.03) 1px, transparent 1px),
                        linear-gradient(90deg, hsla(25, 100%, 50%, 0.03) 1px, transparent 1px);
